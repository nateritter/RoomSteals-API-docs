...
=======
    "DebugData": " Successful Existing Member RT-12345-RST-1",
>>>>>>> Updated to include AdditionalInfo req.
    "Error": null,
...
=======
ReferralId | string | Yes | An agreed upon (RoomSteals + partner) 3 letter partner prefix concatonated with a hyphen and the ID of the user on the partner's system
>>>>>>> Updated to include AdditionalInfo req.
